...
// 五十音表（用於首頁顯示；空字串代表該格無字），全部開放練習
const GOJUON = [
  { label: 'あ', cells: ['あ', 'い', 'う', 'え', 'お'], unlocked: true },
  { label: 'か', cells: ['か', 'き', 'く', 'け', 'こ'], unlocked: true },
  { label: 'さ', cells: ['さ', 'し', 'す', 'せ', 'そ'], unlocked: true },
  { label: 'た', cells: ['た', 'ち', 'つ', 'て', 'と'], unlocked: true },
  { label: 'な', cells: ['な', 'に', 'ぬ', 'ね', 'の'], unlocked: true },
  { label: 'は', cells: ['は', 'ひ', 'ふ', 'へ', 'ほ'], unlocked: true },
  { label: 'ま', cells: ['ま', 'み', 'む', 'め', 'も'], unlocked: true },
  { label: 'や', cells: ['や', '', 'ゆ', '', 'よ'], unlocked: true },
  { label: 'ら', cells: ['ら', 'り', 'る', 'れ', 'ろ'], unlocked: true },
  { label: 'わ', cells: ['わ', '', 'を', '', 'ん'], unlocked: true },
];

// 依五十音順序列出所有可練習的字（用於「上一個／下一個」與測驗）
const KANA_ORDER = ['あ', 'い', 'う', 'え', 'お', 'か', 'き', 'く', 'け', 'こ', 'さ', 'し', 'す', 'せ', 'そ', 'た', 'ち', 'つ', 'て', 'と', 'な', 'に', 'ぬ', 'ね', 'の', 'は', 'ひ', 'ふ', 'へ', 'ほ', 'ま', 'み', 'む', 'め', 'も', 'や', 'ゆ', 'よ', 'ら', 'り', 'る', 'れ', 'ろ', 'わ', 'を', 'ん'];
